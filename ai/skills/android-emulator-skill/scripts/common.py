...
def get_connected_devices() -> List[str]:
    ...
    try:
        ...
        raise RuntimeError(f"Unable to list Android devices{detail}") from error
...
# Backwards-compatible alias for older scripts in this skill.
get_device_screen_size = get_screen_size
