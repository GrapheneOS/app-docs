...
## GrapheneOS App Usage

For GrapheneOS app work, treat this as a Jetpack Compose Material 3 skill by
default.

- Prefer `androidx.compose.material3` and the app's existing `MaterialTheme`.
- Do not introduce Flutter, web, or `@material/web` guidance unless the user is
  explicitly working on those targets.
- Check the app's Compose BOM and Material3 version before using expressive,
  adaptive, or experimental APIs.
- Keep UI consistent with the app's existing theme, resource naming, and
  accessibility conventions.
- Put user-visible strings in Android resources.
- Do not add a new icon, image, font, animation, or adaptive-layout dependency
  without checking the repository's existing dependencies first.
...
**Typeface note:** Roboto is the default Material typeface on Android. Replace
it only when the app intentionally owns a different type scale.
...
| Task | Start with |
|------|------------|
| Full app scaffold | "Common Patterns: App Shell" and [references/layout-and-responsive.md](references/layout-and-responsive.md) |
| Single component | "Component Quick Reference" and [references/component-catalog.md](references/component-catalog.md) |
| Custom theme | [references/theming-and-dynamic-color.md](references/theming-and-dynamic-color.md) |
| Form or input layout | [references/component-catalog.md](references/component-catalog.md) input components |
| Navigation structure | [references/navigation-patterns.md](references/navigation-patterns.md) |
| Data display | [references/component-catalog.md](references/component-catalog.md) data display components |
...
Full details: [references/color-system.md](references/color-system.md)
...
Full details: [references/typography-and-shape.md](references/typography-and-shape.md)
...
**Note:** Components marked with `—` for web element don't have @material/web implementations yet. Use CSS custom properties with standard HTML for these. **Compose** mappings and examples live in [references/component-catalog.md](references/component-catalog.md).
...
- **Adaptive UI**: Window size classes, list-detail and supporting-pane layouts, foldables — see [references/layout-and-responsive.md](references/layout-and-responsive.md) and [references/navigation-patterns.md](references/navigation-patterns.md).
- **Edge-to-edge & insets**: Lay out content with `WindowInsets` / scaffold padding so bars and IME behave correctly — see [references/layout-and-responsive.md](references/layout-and-responsive.md).
...
Full theming guide:
[references/theming-and-dynamic-color.md](references/theming-and-dynamic-color.md)
...
More patterns: [references/navigation-patterns.md](references/navigation-patterns.md),
[references/layout-and-responsive.md](references/layout-and-responsive.md)
...
- **Replace Roboto by default**: On **Android**, **Roboto** is the default
  Material typeface. Replace it only when intentionally customizing the type
  scale.
...
- [references/color-system.md](references/color-system.md) — Color roles, tonal palettes, dynamic color, Compose + CSS mapping
- [references/typography-and-shape.md](references/typography-and-shape.md) — Type scale, shape corners, elevation, motion, Expressive notes
- [references/component-catalog.md](references/component-catalog.md) — Components: Compose + `@material/web` where applicable
- [references/navigation-patterns.md](references/navigation-patterns.md) — Navigation selection, Compose-first adaptive patterns
- [references/layout-and-responsive.md](references/layout-and-responsive.md) — Breakpoints, canonical layouts, insets, foldables
- [references/theming-and-dynamic-color.md](references/theming-and-dynamic-color.md) — Theming: Compose first, then Flutter and web
