...
- **Portable skill layout**: the skill now lives at
  [skills/material-3/SKILL.md](skills/material-3/SKILL.md), with references
  under [skills/material-3/references/](skills/material-3/references/).
...
- Covers **30+ components** with Compose-oriented mappings plus web element
  names where applicable, attributes, and examples in
  [skills/material-3/references/component-catalog.md](skills/material-3/references/component-catalog.md)
...
1. **Planning phase** — Main
   [skills/material-3/SKILL.md](skills/material-3/SKILL.md) plus focused
   reference files under [skills/material-3/references/](skills/material-3/references/).
...
| [skills/material-3/SKILL.md](skills/material-3/SKILL.md) | Main skill: philosophy, decision trees, token overview, component table, Compose-first notes, limited web patterns, audit procedure |
| [skills/material-3/references/color-system.md](skills/material-3/references/color-system.md) | Color roles, tonal palettes, dynamic color, baseline schemes (Compose + CSS) |
| [skills/material-3/references/component-catalog.md](skills/material-3/references/component-catalog.md) | Components with Compose mappings and `@material/web` where applicable |
| [skills/material-3/references/theming-and-dynamic-color.md](skills/material-3/references/theming-and-dynamic-color.md) | Theme generation, brand colors, dark mode — Compose first, then Flutter and web |
| [skills/material-3/references/typography-and-shape.md](skills/material-3/references/typography-and-shape.md) | Type scale, shape, elevation, motion — including Expressive platform notes |
| [skills/material-3/references/navigation-patterns.md](skills/material-3/references/navigation-patterns.md) | Nav selection, Compose-first patterns, responsive shell |
| [skills/material-3/references/layout-and-responsive.md](skills/material-3/references/layout-and-responsive.md) | Breakpoints, canonical layouts, edge-to-edge/insets, foldables |
| [CONTRIBUTING.md](CONTRIBUTING.md) | How to contribute without drifting the Compose-first story |
